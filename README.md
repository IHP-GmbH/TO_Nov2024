...
1. Sign the Hiring Agreement: [samples.rtf](https://github.com/IHP-GmbH/TO_Sep2025/blob/main/drc/samples.rtf) (download i
...
| --- | --- | --- |
| AC3E_USM_TDBUCK | (No short description found in-repo README/metadata) | `AC3E_USM_TDBUCK/` |
| BG | (No short description found in-repo README/metadata) | `BG/` |
| CHIPCHILE_CANELOS24_WorkshopTO | (No short description found in-repo README/metadata) | `CHIPCHILE_CANELOS24_WorkshopTO/` |
| CryoChip | (No short description found in-repo README/metadata) | `CryoChip/` |
...
| ExampleDesign | (No short description found in-repo README/metadata) | `ExampleDesign/` |
...
| MARTIn | (No short description found in-repo README/metadata) | `MARTIn/` |
| MaskedAndUnmaskedAES | (No short description found in-repo README/metadata) | `MaskedAndUnmaskedAES/` |
...
| sg13g2_io_testchip | (No short description found in-repo README/metadata) | `sg13g2_io_testchip/` |
